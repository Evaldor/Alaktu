CREATE TABLE [dbo].[Pipline] (
    ...
    [PrimaryKeyIsUsed] BIT NOT NULL CONSTRAINT [DF_Pipline_PrimaryKeyIsEnabled] DEFAULT (0),
    [PrimaryKeySchemeJson] NVARCHAR (MAX) NULL,
    [VersioningIsUsed] BIT NOT NULL CONSTRAINT [DF_Pipline_VersioningIsUsed] DEFAULT (0),
    [VersioningSchemeJson] NVARCHAR (MAX) NULL,
    [TransferToFlatTableIsEnabled] BIT NOT NULL CONSTRAINT [DF_Pipline_TransferToFlatTableIsEnabled] DEFAULT (0),
